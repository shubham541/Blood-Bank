...
<div style="height:530px; width:700px; margin:auto; margin-top:10px; margin-bottom:10px; background-color:#FBF8F7; border:2px solid red; box-shadow:4px 1px 20px black;">
	<form method="post" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" style="margin:auto; width:100%; " >
			...
			<tr><td  style=" padding-left:20px;" ><img src="Images/banner.png" width="170px" height="380" class="shaddoww"/>&nbsp; </td>
